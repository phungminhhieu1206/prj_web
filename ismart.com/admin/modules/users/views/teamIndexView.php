                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="tbody-thumb">
                                                        <a href='<?php if(!empty($admin['avatar'])){echo $admin['avatar'];} else{echo 'public/images/img-thumb.png';}?>'><img src="<?php if(!empty($admin['avatar'])){echo $admin['avatar'];} else{echo 'public/images/img-thumb.png';}?>" alt=""></a>
                                                    </div>
                                                </td>
                                                <td class="clearfix">
